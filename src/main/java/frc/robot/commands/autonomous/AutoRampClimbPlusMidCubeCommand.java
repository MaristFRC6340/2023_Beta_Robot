...
public class AutoRampClimbPlusMidCubeCommand extends SequentialCommandGroup {
  /** Creates a new AutoRampClimb. */
  public AutoRampClimbPlusMidCubeCommand(DriveSubsystem drive, ShoulderSubsystem shoulder, WristSubsystem wrist, SliderSubsystem slider, IntakeSubsystem intake) {
